...
function throttle(e, t, a) {
  ...
  a || (a = {});
  var c = function() {
      r = !1 === a.leading ? 0 : (new Date).getTime(),
      o = null,
      e.apply(i, n),
      o || (i = n = null)
  };
  return function() {
      ...
      i = this,
      n = arguments,
      m <= 0 || m > t ? (o && (clearTimeout(o),
      o = null),
      r = l,
      e.apply(i, n),
      o || (i = n = null)) : o || !1 === a.trailing || (o = setTimeout(c, m))
  }
}
function isMobile() {
  var e, t = !1;
...
function snackbarShow(e, t, a) {
  var o = void 0 !== t && t
    , i = void 0 !== a ? a : 2e3
    , n = GLOBAL_CONFIG.Snackbar.position
